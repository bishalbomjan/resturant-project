...
for i,restaurant in enumerate(data):
    ...
    for image_url in restaurant["image_url"]:
        cur.execute(
            "INSERT INTO restaurant_image (url, restaurant_id) VALUES (%s, %s)",
    ...
    for ratings in restaurant["rating"]:
        ...
        cur.execute(
                    "INSERT INTO restaurant_ratings (restaurant_id,u_id,username, rating, body) VALUES (%s,%s,%s, %s, %s)",
                    (restaurant_id,u_id,username, rating, comment)
                )
    cur.execute(
        "INSERT INTO restaurant_userprofile (user_id, is_owner) VALUES (%s,%s)",
        (user_id,True)
    )
    cur.execute(
